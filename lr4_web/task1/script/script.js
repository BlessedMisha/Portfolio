...
function applyVerticalAlign() {
    ...
    const verticalAlignValue = document.getElementById('verticalAlign').value;

    text.style.transform = `translateY(${verticalAlignValue}px)`;

    const cssCode = `transform: translateY(${verticalAlignValue}px);`;
...
function applyVisibility() {
    ...
    const cssCode = `visibility: ${visibilityValue};`;
    document.getElementById('outputfyc').value = cssCode;
}
